...
PROGRAM wf1e
  ...
  USE wf_1e,        ONLY: read_wf1e, write_wf1e, write_lopt_wf1e, write_all_wf1e, save_wf1e_nl, write_fx, write_fx_bsp
  USE wf_1e,        ONLY: evaluate_dipoles, evaluate_overlaps, evaluate_overlap_dipoles
  USE wf_1e,        ONLY: evaluate_dipoles_diatomics, evaluate_dipoles_diatomics_2
...
!
  ...
  save_wf1e_binary_grid:IF(action=='save') THEN     ! Rwf1e l= 0  
     ...
     !CALL write_all_wf1e(n_a, l_a, en, ce)   ! store radial wfs p_nl(r),p'_nl(r)
