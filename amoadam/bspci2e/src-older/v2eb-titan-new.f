...
C         READ( NCFG, 3 ) itry
         ...
         do ir = 1, ncs
           print*, nllmax(ir), nmx
           IF(nllmax(ir).gt.nmx) THEN
              print*, '# max orbital in inp/cfg-L.inp, l = ', inpl
              print*, '# exceeds b-spline size ns'
              print*, '#         must be   n1e <= nllmax(ir)'
              print*, '#                  nllmax(ir) = ', nllmax(ir), ir 
              print*, '#                         n1e = ', nmx
              print*, '#                          ir = ', ir
              print*, '# exciting.'
              STOP
