...
!!!...................................
  ...
  WRITE(*,*) ' CS_2           = ', CS_2
  WRITE(*,*) ' CS_2_SI        = ', CS_2_SI
  WRITE(*,*) ' CS_2 * CS_2_SI = ', CS_2 * CS_2_SI
...
!            WRITE(*,*) ' Ef(irb), nd  = ', enfb(irb) , nofb(irb), irb
!            WRITE(*,*) ' < icb | D | irb, j > = ',(dmxbfb(j), j = 1, nofb(irb))
...
!            WRITE(*,*) ' W_PHOTON(IRB)  = ', W_PHOTON(IRB) 
!            WRITE(*,*) ' DETUNING       = ', DE
!            WRITE(*,*) ' nofb      = ', DE
...
!            DO j = 1, noib(icb)
               ...
               cs2phb(irb,i) = cs2ph(irb,i) + dmxbb * dmxbfb(i) / DE
               
!               WRITE(*,*) 'cs2phb = ', j, cs2phb(irb,i), dmxbb, dmxbfb(i) 
 !           END DO
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
         ...
         WRITE(*,*) ' ==> CONTINUUM PART OF CROSS SECTIONS :: '
         ...
         DO i = 1, nof(ir)
            ...
            DO j = 1, noi(ic)
               ...
               IF( ABS(DE).LE.ABS(20*DE_STEP/2.0D+00)) THEN
                  ...
                  cs2ph(ir,i) = cs2ph(ir,i) !!- PI * uim *  dmxbf(j) * dmxff(j,i) * 2.0D+00/DE_STEP
