...
C#
     ...
     1  DRKR(1),RKK(1)
      ...
      IF(IDR.EQ.1) CALL YKLINB(P,PP,YK,ZK,WY,WZ,R,DR,DRKR,RKK,H,K,NO)
      IF(IDR.EQ.2) CALL YKEXPB(P,PP,YK,ZK,WY,WZ,R,DR,DRKR,RKK,H,K,NO)
...
C*
C*
      SUBROUTINE YKLINB(P,PP,YK,ZK,WY,WZ,R,DR,DRKR,RKK,H,K,NO)
      IMPLICIT REAL*8(A-H,O-Z)
c
      DIMENSION P(1),PP(1),YK(1),ZK(1),WY(1),WZ(1),R(1),DR(1)
      DIMENSION DRKR(1),RKK(1)
