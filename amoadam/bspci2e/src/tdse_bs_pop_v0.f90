...
END MODULE atom_2e_v0
!
!
!
PROGRAM tdse_bs_pop_v0 !only the l1=1,l2=1 channels are fully analyzed
  !
  USE PRECISION
  ...
  REAL(dpk), ALLOCATABLE, DIMENSION(:)        :: popl_1,popl_2 !
...
!  pop_e2d_l12_channels(l:icl:k1,k2)
  ...
  ALLOCATE(                  popl_1( 0:lmax) )
  ALLOCATE(                  popl_2( 0:lmax) )
  ...
  popl_e1 = 0.0_dpk
  popl_1  = 0.0_dpk
  probability_e1:DO l = 0, lmax

     sum_this_1 = 0.0_dpk 
     electron_1:DO k1 = 1, ne_1e_cut
        
        sum_this_2 = 0.0_dpk        
        sum_over_electron_2:DO k2 = k1, ne_1e_cut
           
           IF(rho_e1e(1,k2).LT.1.0e-300_dpk) STOP
           
           sum_this_2 = sum_this_2 + popl_e1e2(l,k1,k2)/rho_e1e(le2,k2)
           
        ENDDO sum_over_electron_2
        
        popl_e1(l,k1) = sum_this_2

        sum_this_1 = sum_this_1 + sum_this_2/rho_e1e(le1,k1)
  ...
  popl_e2 = 0.0_dpk
  popl_2 = 0.0_dpk ; 
  probability_e2:DO l = 0, lmax

     sum_this_2 = 0.0_dpk
     electron_2:DO k2 = 1, ne_1e_cut
        
        sum_this_1 = 0.0_dpk
        sum_over_electron_1:DO k1 = k2, ne_1e_cut
           IF(rho_e1e(1,k1).LT.1.0e-300_dpk) STOP
           sum_this_1 = sum_this_1 + popl_e1e2(l,k1,k2)/rho_e1e(le1,k1)
           
        ENDDO sum_over_electron_1
        
        popl_e2(l,k2) = sum_this_1
        sum_this_2 = sum_this_2 + sum_this_1/rho_e1e(le2,k2)        
     ENDDO electron_2
  ...
  !
     ...
     DO k2 = 1, ne_1e_cut
        ...
        IF(e1e(1,k2)>0.0_dpk) THEN 
           WRITE(nout,'(15E15.6)') e1e(1,k2), popl_e2(0:lmax,k2), SUM(popl_e2(:,k2))
        ENDIF
     ENDDO
     CLOSE(nout)
   ...
   !!!!!!!!!!   find P(e1,e2) = d^2/dek1*dek2(ek1,ek2)  for all partial waves l1,l2
     ...
     grid_e1e2:DO k1 = 1, ne_1e_cut
        DO k2 = 1, ne_1e_cut
           IF( (e1e(1,k1)>0).AND.(e1e(1,k2)>0) )  THEN
              WRITE(nout,*) e1e(1,k1),e1e(1,k2)    !(x,y,z) points
           ENDIF
        ENDDO
     ENDDO grid_e1e2     
     !
 ...
 pop_di_0 = pop_d_ss + pop_d_pp + pop_d_dd + pop_d_ff + pop_d_sp + pop_d_pd  + pop_d_df + pop_d_sd + pop_d_pf + pop_d_sf
  ...
  PRINT*, 'x'
  WRITE(*,'(A15,2X, 1P10E15.7)')  '   pop_d_ss  = ', pop_d_ss,   SUM(pop_d_ss)
  WRITE(*,'(A15,2X, 1P10E15.7)')  '   pop_d_pp  = ', pop_d_pp,   SUM(pop_d_pp)
  WRITE(*,'(A15,2X, 1P10E15.7)')  '   pop_d_dd  = ', pop_d_dd,   SUM(pop_d_dd)
  WRITE(*,'(A15,2X, 1P10E15.7)')  '   pop_d_ff  = ', pop_d_ff,   SUM(pop_d_ff)
  WRITE(*,'(A15,2X, 1P10E15.7)')  '   pop_d_sp  = ', pop_d_sp,   SUM(pop_d_sp)
  WRITE(*,'(A15,2X, 1P10E15.7)')  '   pop_d_pd  = ', pop_d_pd,   SUM(pop_d_pd)
  WRITE(*,'(A15,2X, 1P10E15.7)')  '   pop_d_df  = ', pop_d_df,   SUM(pop_d_df)
  WRITE(*,'(A15,2X, 1P10E15.7)')  '   pop_d_sd  = ', pop_d_sd,   SUM(pop_d_sd)
  WRITE(*,'(A15,2X, 1P10E15.7)')  '   pop_d_pf  = ', pop_d_pf,   SUM(pop_d_pf)
  WRITE(*,'(A15,2X, 1P10E15.7)')  '   pop_d_sf  = ', pop_d_sf,   SUM(pop_d_sf)
  WRITE(*,'(A15,2X, 1P10E15.7)')  '   pop_sum   = ', pop_di_0,   SUM(pop_di_0)
  PRINT*, 'x'  
  WRITE(*,'(A15,2X, 1P10E15.7)')  '   pop_pp_1  = ', popl_1,   SUM(popl_1)
  WRITE(*,'(A15,2X, 1P10E15.7)')  '   pop_pp_2  = ', popl_2,   SUM(popl_2)
