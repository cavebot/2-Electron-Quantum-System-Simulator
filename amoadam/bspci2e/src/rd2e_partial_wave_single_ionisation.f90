...
loop_L: do l = 0, 3!lmax
  ...
  !  ie_max = 1053
  !end if
  write(*,*) "#ie min = ", nsi_l(l), "#ie max = ", ie_max
  ...
  loop_r1: do ir1 = 1, nof_points2
    loop_r2: do ir2 = ir1, nof_points2
      !write(*,*) "point", ir2 + nof_pointsnsi_l(l)2*ir1

      work = 0.0_dpk

      loop_total_energy: do ie = nsi_l(l), ie_max
...
write ( *, * ) 'Elapsed real time = ', real ( t2 - t1 ) / real ( clock_rate )
 ...
 write(rd2efilename,"(a,i1,i1)") "rd2e/partial-waves/2f-partial-waves-si-", l1_int,l2_int
