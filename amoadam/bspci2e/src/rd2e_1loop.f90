...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        work2 = 0.0_dpk
        loop_r1_prime: do ir1 = 1, nof_points

          p1p     = p( ir1, nn1,  ll1 )
          p1p_bar = p( ir1, nn1,  ll2 )

          loop_r2_prime: do ir2 = ir1, nof_points

            p2p     =  p( ir2, nn2,  ll2 )
            p2p_bar =  p( ir2, nn2,  ll1 )
            work2(ir1,ir2) =  p1p * p2p +  p1p_bar * p2p_bar
...
write ( *, * ) 'Elapsed real time = ', real ( t2 - t1 ) / real ( clock_rate )
 ...
 open(19, file = "radial-distributions/rd2e-L2-1000-di.out", status = 'replace')
