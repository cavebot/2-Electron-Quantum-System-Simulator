...
C*    in total    |njj - nj|  DME
      ...
      if(gauge.eq.'v') then
         ...
         mode = 0 
         write(16,*) ' Dv(n', l,' -> m', l+1, ')'
      else
            
         mode = 1
         write(16,*) ' Dl(n', l,' -> m', l+1, ')'
      endif
...
C*    However the final result for the velocity gauge
C*    (DME_v) doesn't depend on Z.
C*
C*   -2- 
