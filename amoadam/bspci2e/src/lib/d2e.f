...
C      PARAMETER(nhx=2500, ncs=30, lf = 10)
      dimension h(nhx,nhx), u(nhx,nhx)
      dimension ih(nhx),nhf(NCS),lhf(NCS),ll(NCS),nllmin(NCS)
      dimension nllmax(NCS),noll(NCS),is(NCS),nd(NCS),ndi(NCS), n(lf)
      CHARACTER*100 ARGV 
C..........................
...
C#
C#      Get the configurations available 
C#
