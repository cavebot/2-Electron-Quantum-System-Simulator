...
PROGRAM tdse_pop_sdi
  ...
  INTEGER                                     :: ne_1e, nl_1e
  REAL(dpk), ALLOCATABLE, DIMENSION(:,:,:)    :: sum_d_ll_0
  ...
  INTEGER                                     :: le1,le2
  !
  REAL(dpk), ALLOCATABLE, DIMENSION(:,:)      :: popl_e1        !
  ...
  !ENDDO
     ...
     !
     ! work out the 1-electron energies
     !          
     !l1e_max : is the max angular channel of the 1e-states included in the cfg
     !lmax_1e : the nof angular channels calculated for the 1e-states
     ...
     ! from conformity reasons we rewrite
     ! en1e(1:nl_1e,1:ne_1e) --> e1e(0:nl_1e-1,1:ne_1e) -->
     
     ALLOCATE(e1e(0:nl_1e,1:ne_1e))
     
     DO l=1,nl_1e
        DO ie = 1, ne_1e
           e1e(l-1,ie) = en1e(l,ie)
        ENDDO
     ENDDO
     deallocate(en1e)
...
!  ENDDO
  ...
  !
  ALLOCATE(  popl_e1e2( 0:lmax,  1:ne_1e, 1:ne_1e) )  !2e
  ALLOCATE(   pop_e1e2( 1:ne_1e, 1:ne_1e) )           !2e
  ALLOCATE(    popl_e1( 0:lmax,  1:ne_1e) )           !2e, pop(L2e,e1)
  ...
  angular_symmetry_2e_zero_order:DO l = 0, lmax
     ...
     sum_all_configurations: DO ic = 1, w2e(l)%ncf
        ...
        pick_channels:IF( (e1>0).AND.(e2>0) )  THEN
           ...
           sum_d_ll_0(l, le1, le2) = sum_d_ll_0(l, le1, le2 ) + pe
           ...
           IF((le1.EQ.1).AND.(le2.EQ.1)) THEN
              ...
              !             one_electron_probability:IF(e1>e2) THEN 
              !              popl_e1(l,k1)      = popl_e1(l,k1) + pe*rho_e1e(le1,k1)
              !              popl_e1(l,k1)      = popl_e1(l,k1) + pe*rho_e1e(le1,k1)
              !             ENDIF one_electron_probability
  ...
  probability_e1:DO l = 0, 2
     ...
     electron_1:DO k1 = 1, ne_1e-11
        
        sum_this = 0.0_dpk
        sum_over_electron_2:DO k2 = 1, ne_1e-11
           IF(rho_e1e(1,k2).EQ.0) STOP
           sum_this = sum_this + popl_e1e2(l,k1,k2)/rho_e1e(1,k2)
  ...
  DO k1 = 1, ne_1e-11
     ...
     IF(e1e(1,k1)>0.0_dpk) THEN 
        WRITE(10,'(5E15.6)') e1e(1,k1), popl_e1(0,k1), popl_e1(2,k1)
     ENDIF
  ENDDO
  ...
  DO k1 = 1, ne_1e-11
     WRITE(12,*) pop_e1e2(k1,:)
  ENDDO

  
  !
  propability_e1e2:DO k1 = 1, ne_1e-11
     DO k2 = 1, ne_1e-11
        IF( (e1e(1,k1)>0).AND.(e1e(1,k2)>0) )  THEN
           WRITE(13,*) e1e(1,k1),e1e(1,k2),pop_e1e2(k1,k2)
        ENDIF
     ENDDO
  ...
  DO k1 = 1, ne_1e-11
     DO k2 = k1, ne_1e-11
        IF( (e1e(1,k1)>0).AND.(e1e(1,k2)>0) )  THEN
           WRITE(14,*) e1e(1,k1),e1e(1,k2), pop_e1e2(k1,k2), pop_e1e2(k2,k1)
        ENDIF
  ENDDO
ENDDO
  !  
  ...
  pop_di_0 = pop_d_ss + pop_d_pp + pop_d_dd + pop_d_ff + pop_d_sp + pop_d_pd  + pop_d_df + pop_d_sd + pop_d_pf 
  ...
  PRINT*, 'x'
  PRINT*, '                        E  < E+     pop_b_0 = ',   popl_b_0,  SUM(popl_b_0)
  PRINT*, '                        E  < E+     pop_b_v = ',   popl_b_v,  SUM(popl_b_v)
  PRINT*, 'x'
  PRINT*, 'xxxxxxxxxxxxxxxxxxxxxxxxxxx   single ionization'
  PRINT*, 'x'
  PRINT*, ' (e1>0 or e2>0) and  E+  < E < E++    pop_s_0 = ', popl_s_0,  SUM(popl_s_0)
  PRINT*, '                     E+  < E < E++    pop_s_v = ', popl_s_v,  SUM(popl_s_v)
  PRINT*, 'x'
  PRINT*, 'xxxxxxxxxxxxxxxxxxxxxxxxxxx   double ionization'
  PRINT*, 'x'
  PRINT*, ' (e1,e2 > 0) and           E++ < E    pop_d_0 = ', popl_d_0,  SUM(popl_d_0)
  PRINT*, '                           E++ < E    pop_d_v = ', popl_d_v,  SUM(popl_d_v)
  PRINT*, 'x'  
  PRINT*, 'xxxxxxxxxxxxxxxxxxxxxxxxxxx   total population'
  PRINT*, 'x'
  PRINT*, '                                       norm_0 = ', norm_0, SUM(popl_0)  !`
  PRINT*, '                                       norm_v = ', norm_v, SUM(popl_v)  !
  PRINT*, 'x'
  PRINT*, 'xxxxxxxxxxxxxxxxxxxxxxxxxxx '
  PRINT*, 'xxxxxxxxxxxxxxxxxxxxxxxxxxx   double ionization'
  PRINT*, 'x'
  PRINT*, ' (e1,e2 > 0) and           E++ < E    pop_dd = ', popl_d_0,   SUM(popl_d_0)
  ...
  PRINT*, '   pop_sum   = ', pop_di_0,   SUM(pop_di_0)
  PRINT*, 'x'  
