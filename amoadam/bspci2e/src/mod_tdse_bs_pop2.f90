  ...
  SUBROUTINE read_w2e_ci(this,li)   ! Coulombic interaction
    ...
    !    loop_L_symmetries: DO li = 0, lmax
     ...
     !f90
       ...
       !       DO k1 = 0, l1e_max
       !   DO k2 = 0, l1e_max
       !      WRITE(*,*), "l1_max, l2_max, k1,k2,l12(k1,k2) = ", k1, k2, this%l12(k1,k2), l1e_max
       !   ENDDO
       !END DO
   ...
   !
   !
   SUBROUTINE  read_w2e_ct(this, lmax, cycle)
     !
     USE netcdf
     USE ncFile_new
     USE units,          ONLY: zi
     ...
     PRINT*, "dim_1 = cycle choice =  ", cycle
     PRINT*, "dim_2 =  ", dim_2
     ...
     DO l = 0, lmax
        re_part_of_ct:DO ie = 1, this(l)%net
           ...
           yr = rm_nc( cycle, ie + lstart(l) - 1)  ! assign the real part of ct(ie)
